  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 50 }}>
        ...
        >
          <Meta
            title={<span style={{ fontWeight: 400 }}>KanBan Template</span>}
          />
        </Card>
        <Card
          hoverable
        ...
        >
          <Meta
            title={<span style={{ fontWeight: 400 }}>WorkSpaces Template</span>}
          />
        </Card>
        <Card
          hoverable
        ...
        >
          <Meta
            title={<span style={{ fontWeight: 400 }}>Trello Template</span>}
          />
        </Card>
      </div>
    </div>
